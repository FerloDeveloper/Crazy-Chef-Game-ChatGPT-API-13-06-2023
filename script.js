...
La ricetta deve essere particolare e un po' folle, con un titolo creativo e divertente.
...
<p>${content.istruzioni}</p>`;
	...
	const imageResponse = await makeRequest(OPENAI.API_IMAGE, {
		prompt: `Crea una immagine gourmet e particolare per questa ricetta: ${content.titolo}`,
		n: 1,
		size: "512x512",
	});
...
function getRandomLoadingMessage() {
	const messages = [
		...
		"Tolgo le bucce...",
		"Pulisco il ripiano...",
		"Affilo le lame dei coltelli...",
		"Assaggio un cucchiaino di salsa per verificare il sapore...",
		"Faccio un balletto con la spigola...",
		"Stendo una tovaglia colorata sulla tavola...",
		"Sfoglio un libro di ricette alla ricerca di ispirazione...",
    "Raccolgo quello che mi è caduto..."
	];
